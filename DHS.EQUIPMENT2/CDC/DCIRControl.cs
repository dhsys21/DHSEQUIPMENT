...
{
    public partial class DCIRControl : UserControl
    {
        #region Delegation
        ...
        Util util = new Util();
        private static DCIRControl dcirControl = new DCIRControl();
        public static DCIRControl GetInstance()
        {
            if (dcirControl == null) dcirControl = new DCIRControl();
            return dcirControl;
        }
        public DCIRControl()
        {
        ...
        {
            dgvRecipe.RowsDefaultCellStyle.BackColor = Color.White;
            dgvRecipe.AlternatingRowsDefaultCellStyle.BackColor = Color.White;
            dgvRecipe.ClearSelection();
            dgvRecipe.DefaultCellStyle.Font = new Font("Times New Roman", 10);
            dgvRecipe.ColumnHeadersDefaultCellStyle.Font = new Font("Times New Roman", 10);
        }
