...
{
    public partial class MeasureChartForm : Form
    {
        ...
        private static MeasureChartForm measureChartForm = new MeasureChartForm();

        public static MeasureChartForm GetInstance()
        {
            if (measureChartForm == null) measureChartForm = new MeasureChartForm();
            return measureChartForm;
        }
        public MeasureChartForm()
        {
            InitializeComponent();

            this.DoubleBuffered = true;
            
            gbStageInfo.Width = 320;
            pnlFooter.Height = 108;
            //* make checkbox
            MakeChannelCheckBox();
        }
